...
INSERT INTO tblProductDetail(provider_ID, product_ID, name, quantity, price, image, description, status) VALUES ('homefurniture','1','Dinner Spoon Silver',50,30000, 'https://assets.stickpng.com/images/580b57fcd9996e24bc43c566.png' , 'A large, silver-plated vegetable spoon with the matching potato spoon from WMFs Rome series.The spoons are ideal for serving a wide variety of vegetables.Great companion on an elegantly set dining table.' ,1 )
...
INSERT INTO tblProductDetail(provider_ID, product_ID, name, quantity, price, image, description, status) VALUES ('homefurniture','1','Tea Spoon Chrome',50,65000, 'https://www.actionsales.com/pub/media/catalog/product/cache/c2b63da0194125490de3b7e711a8c284/i/m/image_96_1.png' , 'A large, silver-plated vegetable spoon with the matching potato spoon from WMFs Rome series.The spoons are ideal for serving a wide variety of vegetables.Great companion on an elegantly set dining table.' ,1 )
...
INSERT INTO tblProductDetail(provider_ID, product_ID, name, quantity, price, image, description, status) VALUES ('homefurniture','3','Pro-x Deep Cooking Pot',50,120000, 'https://media.croma.com/image/upload/v1650435740/Croma%20Assets/Small%20Appliances/Food%20Processors/Images/251576_edgdtg.png' , 'A large, silver-plated vegetable spoon with the matching potato spoon from WMFs Rome series.The spoons are ideal for serving a wide variety of vegetables.Great companion on an elegantly set dining table.' ,1 )
...
, 'A large, silver-plated vegetable spoon with the matching potato spoon from WMFs Rome series.The spoons are ideal for serving a wide variety of vegetables.Great companion on an elegantly set dining table.' ,1 )
INSERT INTO tblProductDetail(provider_ID, product_ID, name, quantity, price, image, description, status) VALUES
('provider1','9','Combo Grilled Meat 560g',50,265000, 'https://cdn.shopify.com/s/files/1/0525/5829/9312/products/01_Starter_570x570.png?v=1615520877' , 'A large, silver-plated vegetable spoon with the matching potato spoon from WMFs Rome series.The spoons are ideal for serving a wide variety of vegetables.Great companion on an elegantly set dining table.' ,1 )
INSERT INTO tblProductDetail(provider_ID, product_ID, name, quantity, price, image, description, status) VALUES
...
INSERT INTO tblServiceCategory(category_ID, name, image) VALUES ('HC', 'Home Cleaning', 'https://housecleaningservicemarcela.files.wordpress.com/2020/08/rsz_2cleaning-supplies.png?w=450')
INSERT INTO tblServiceCategory(category_ID, name, image) VALUES ('HI', 'Home Improvement', 'https://www.credible.com/blog/wp-content/uploads/2021/10/15-Home-Improvement-Projects-to-Complete-Before-You-List-Your-Home-F9F6EE-600x437.png')
