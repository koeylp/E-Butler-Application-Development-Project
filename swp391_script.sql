...
select * from tblUser
delete from tblUser where username = 'VIET DANG'
...
select username from tblCustomer where username = '';

delete from tblCustomer where username = 'VIET DANG'
insert into tblCustomer([username], [password], [role_ID], [phone], [email], [name], gender, dob, avatar, [status])
				values('VIET DANG', '123','CUS', '', 'vietdh@gmail.com', 'Viet', 0, '', '', 1)
