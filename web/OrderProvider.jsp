<%-- 
    Document   : OrderProvider
    Created on : Oct 9, 2022, 10:58:57 PM
    Author     : DELL
--%>
  ...
  <div class="container-xxl">
    <div class="container-fluid nav-bar bg-white px-0">
      ...
      <div class="mt-3 ms-5 d-flex justify-content-start ">
        <div>
          <h2 style="font-weight:600 ;" class="">Orders List</h2>
        </div>
      </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body  py-3 ">
              <div class="d-flex justify-content-around mb-3">
                <div class="card" style="width:300px ; height: 194px;">
                  <div class="card-body">
              ...
              <div class="row">
                <div class="row">
                  <div class="col mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Username" id="hiddenValue"> 
                  </div>
                  <div class="col mb-3">
                ...
                <div class="row">
                  <div class="col mb-3">
                    ...
                    <input type="text" id="username" class="form-control" placeholder="1" id="hiddenValue1">
                  </div>
                  <div class="col mb-3">
                    <label for="productname" class="form-label">Price</label>
                    <input type="text" id="username" class="form-control" placeholder="1" id="hiddenValue2">
                  </div>
                </div>
                <div class="mb-3">
          ...
          <div class="me-5 mb-3 d-flex">
            ...
            <div class="btn-group ms-2">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="javascript:void(0);"><i class="bx bx-sort-a-z m-1"></i>Sort by
                    date</a>
                </li>
                <li><a class="dropdown-item" href="javascript:void(0);"><i class="bx bx-sort-down m-1"></i>Sort by price
                    up</a></li>
                <li><a class="dropdown-item" href="javascript:void(0);"><i class="bx bx-sort-up m-1"></i>Sort by price
                    down</a></li>
              </ul>
            </div>
          </div>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
        $(document).on('click','modalToggle', function(){ 
            var first = $('id').text() ;  
            var second = $('date').text() ;  
            var third = $('price').text() ;  
            
            
            $('#hiddenValue').val(first) ;  
            $('#hiddenValue1').val(second) ;  
            $('#hiddenValue2').val(third) ;  
