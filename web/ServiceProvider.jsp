<%-- 
    ...
    Created on : Oct 9, 2022, 10:56:41 PM
    Author     : DELL
--%>
            ...
            <div class="container-fluid nav-bar bg-white px-0">
                ...
                <div class="modal js-modal-confirm" id="modalToggle" aria-hidden="true">
                    <div class="modal-dialog  modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalToggleLabel">Edit Service</h5>
                    ...
                    <div class="bg-white container-fluid d-flex justify-content-between border-bottom  "
                        ...
                        <div class="me-5 mb-3 d-flex">
                            ...
                            <form class="d-flex" action="MainController" method="post">
                                <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" name="SearchProviderService" value="<%= search%>" >
                                <button class="btn btn-primary" name="action" value="SearchProviderService" type="submit">Search</button>
                            </form>
                            ...
                            <form action="MainController" method="post">
                                <div class="btn-group ms-2">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><button type="submit" name="action" value="Ser_sortByName" class="dropdown-item" ><i class="bx bx-sort-a-z m-1"></i>Sort by
                                                name</button>
                                        </li>
                                        <li><button type="submit" name="action" value="Ser_sortByPriceUp" class="dropdown-item" ><i class="bx bx-sort-down m-1"></i>Sort by price
                                                up</button>
                                        </li>
                                        <li><button type="submit" name="action" value="Ser_sortByPriceDown" class="dropdown-item" ><i class="bx bx-sort-up m-1"></i>Sort by price
                                                down</button>
                                        </li>
