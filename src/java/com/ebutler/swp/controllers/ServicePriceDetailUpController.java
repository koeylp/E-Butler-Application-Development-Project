 ...
 * @author Dang Viet
 */
public class ServicePriceDetailUpController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ServiceDetailDTO> list = dao.sortListServiceDetailByTypePriceUP(category_ID, service_ID);
