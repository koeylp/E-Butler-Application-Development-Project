 ...
 * @author Admin
 */
public class WordServiceCategoryDownController extends HttpServlet {

    private String ERROR = "errorPage.jsp";
    private String SUCCESS = "customer_serviceCategoryPage.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ServiceDTO> list = dao.sortServiceCategoryWordDOWN(categoryID);
