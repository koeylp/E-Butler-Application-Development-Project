 ...
 * @author DELL
 */
public class Search_Provider_ProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String search = request.getParameter("SearchProviderProduct") ; 
            ProviderDAO providerDao = new ProviderDAO() ; 
            HttpSession session = request.getSession() ; 
            ProviderDTO provider = (ProviderDTO) session.getAttribute("LOGIN_PROVIDER") ; 
            listSearch = providerDao.searchProduct(provider, search) ;
            if (listSearch != null) {
                session.setAttribute("Provider_ListProduct", listSearch); 
