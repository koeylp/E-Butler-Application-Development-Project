 ...
 * @author Admin
 */
public class LoadingReviewController extends HttpServlet {
    
    private final String ERROR = "errorPage.jsp";
    private final String SUCCESS = "customer_productPage.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("ERROR at LoadingReviewController: " + e.toString());
        } finally {
